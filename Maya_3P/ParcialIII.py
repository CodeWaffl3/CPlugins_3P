...
class M_Window(object):
    ...
    def createLandScape(self, *args):
        ...
        if (randHeightMap == 5):
            path = f"D:/Andres/Documents/MayaProjects/{randHeightMap}.jpeg"
        else:
            path = f"D:/Andres/Documents/MayaProjects/{randHeightMap}.jpg"
        ...
        # importa el objeto
        cmds.file("C:/Users/Andres/Downloads/Plugins_TercerParcial/ObjetosFBX/ReconPole.fbx", i=True)
        ...
        # Importa el objeto
        cmds.file("C:/Users/Andres/Downloads/Plugins_TercerParcial/ObjetosFBX/House.fbx", i=True)
        ...
        # Importa los objetos
        cmds.file("C:/Users/Andres/Downloads/Plugins_TercerParcial/ObjetosFBX/Trees/Trees.ma", i=True)
